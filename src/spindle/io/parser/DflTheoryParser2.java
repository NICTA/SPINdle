...
public class DflTheoryParser2 extends AbstractTheoryParser {
	...
	public static Map<Literal, Map<ConclusionType, Conclusion>> getConclusions(String conclusionsString, AppLogger logger) throws ParserException {
		if (null == INSTANCE) INSTANCE = new DflTheoryParser2();
	...
	public static String getLiteralFunctionEvaluationString(final String literalFunctionStr, //
			Map<LiteralVariable, LiteralVariable> literalVariableMapping, Map<LiteralVariable, String> literalBooleanFunctionAnswers) throws ParserException {
		if (null == INSTANCE) INSTANCE = new DflTheoryParser2();
