...
/**
 * Application constant for representing the current date time.
 * 
 * @author H.-P. Lam (oleklam@gmail.com), National ICT Australia - Queensland Research Laboratory
 * @since 2011.07.26
 * @since version 2.1.0
 */
public class Now extends AppConstantBase {
	public static final String LABEL = DomConst.Literal.LITERAL_VARIABLE_PREFIX + "NOW";
	public static final String DESCRIPTION = "current time";
	public static final String USAGE = LABEL;
	public static final int NO_OF_ARGUMENTS = 0;
	protected static final String CODE_BASE = "com.app.utils.DateTime.getCurrentDateTime().getTimeInMillis()";
	...
	protected void verifyArguments(boolean isNegation, String[] args) throws InvalidArgumentException {
		if (isNegation) throw new InvalidArgumentException(ErrorMessage.LITERAL_VARIABLE_CANNOT_BE_NEGATED,
				new Object[] { LABEL });
	}
