...
/*
void conclusionExpression(): {
} {
 conclusionTerm() ( <EOL> conclusionTerm() )*
}*/
...
// String element=null;
 ...
 String predicate=null;
  ...
  if (null!=lv) {
   ...
   {if (true) return preds.substring(1,preds.length()-1);}
  }
 ...
 Token startTime,endTime=null;
  ...
  if (null!=endTime) temporal.setEndTime(Long.parseLong(endTime.image));
...
*/
 ...
 Temporal ruleTemporal=null;
  ...
  try{
   Rule rule=getDefaultRule(theory.getUniqueRuleLabel());
   if (null!=ruleLabel) rule.setLabel(ruleLabel.image);
   if (null!=ruleMode) rule.setMode(ruleMode);
